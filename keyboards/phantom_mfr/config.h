...
#define USBSTR_MANUFACTURER    'M', '\x00', 'F', '\x00', 'R', '\x00'
#define PRODUCT         PHANTOM
#define USBSTR_PRODUCT         'P', '\x00', 'h', '\x00', 'a', '\x00', 'n', '\x00', 't', '\x00', 'o', '\x00', 'm', '\x00', ' ', '\x00', 'Q', '\x00', 'M', '\x00', 'K', '\x00', ' ', '\x00', 'C', '\x00', 'h', '\x00', 'i', '\x00', 'b', '\x00', 'i', '\x00'
